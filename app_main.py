                ...
                if now - state.last_update >= 1:
                    ...
                    if state.remaining_time <= 0:
                        if state.mode == "pomodoro":
                            ...
                            state.remaining_time = 15 * 1 if state.mode == "long_break" else 5 * 1
                        else:
                            state.mode = "pomodoro"
                            state.remaining_time = 25 * 1
